...
import EligibleGameList from "./eligibleGameList";

const EligibleGameModal = () => {
  const isOpen = useAppSelector((state) => state.dialogState.beligibleGameModal);
...
export default EligibleGameModal;
