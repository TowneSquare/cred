...
const PointLogo = () => {
  const referralPoint = useAppSelector((state) => state.credpointsState.referralPoint);
  ...
  return (
    ...
    >
      <p className="text-[32px] md:text-[48px] font-semibold">{visitorMode ? "???" : referralPoint.toLocaleString()}</p>
