...
const Email = () => {
  ...
  return (
    <>
      <div className={`bg-[#1B1B1B] w-[90%] ${connected ? 'h-[216px]' : 'h-[357px]'} ${inputText && !isValidEmail ? 'md:h-[230px]' : 'md:h-[195px]'} py-8 px-4 md:px-8 grid md:flex items-center border border-gray-light-2 rounded-xl mb-4 md:justify-between`}>
        {connected ? (
          <>
